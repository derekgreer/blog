...
date: 2010-04-24T13:52:32+00:00
author: derekgreer
layout: post
guid: http://www.aspiringcraftsman.com/?p=343
permalink: /2010/04/24/the-agile-visitor/
dsq_thread_id:
  - "261600810"
categories:
  - Uncategorized
...
[<img class="alignnone size-full wp-image-344" title="VisitorClassDiagram" src="/wp-content/uploads/2010/04/VisitorClassDiagram.png" alt="" width="590" height="548" srcset="http://aspiringcraftsman.com/wp-content/uploads/2010/04/VisitorClassDiagram.png 2049w, http://aspiringcraftsman.com/wp-content/uploads/2010/04/VisitorClassDiagram-300x278.png 300w, http://aspiringcraftsman.com/wp-content/uploads/2010/04/VisitorClassDiagram-1024x950.png 1024w" sizes="(max-width: 590px) 100vw, 590px" />](/wp-content/uploads/2010/04/VisitorClassDiagram.png)

[
  
]($VisitorClassDiagram7.png) 
...
<div class="theme-note">
  ...
  <p>
    To overcome this limitation, a technique known as <a href="http://www.aspiringcraftsman.com/2010/04/double-dispatch-is-a-code-smell/" target="_blank">Double Dispatch</a> is used to ensure that the correct Visitor method is statically dispatched.
  </p>
...
<pre class="brush:csharp">class ThermostatVisitor : IVisitor&lt;Thermostat&gt;
    {
...
<pre class="brush:csharp">class Manifest
    {
...
<pre class="brush:csharp">class PartsManifestVisitorFacade : IVisitor&lt;IVisitable&gt;
    {
