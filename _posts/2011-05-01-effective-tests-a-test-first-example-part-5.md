...
In [part 4](/2011/04/24/effective-tests-a-test-first-example-part-4/) of our Test-First example, we continued by addressing issues filed by the UI team. To conclude our example, we’ll finish the remaining issues this time.
