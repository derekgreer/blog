...
tags:
  - Testing
---
In <noindex></noindex> the [last](http://www.aspiringcraftsman.com/2011/06/24/effective-tests-expected-objects/) installment of our series, we looked at the Expected Object pattern as a way to reduce code duplication, eliminate the need to add test-specific equality concerns to production code and to aid in clarifying the intent of our tests. This time we’ll take a look at some practices and techniques for avoiding context obscurity.
...
<pre class="brush:csharp; gutter:false; wrap-lines:false; tab-size:2;">public class when_processing_a_payment_with_an_expired_credit_card
{
...
<pre class="brush:csharp; gutter:false; wrap-lines:false; tab-size:2;">public class when_the_customer_requests_product_information
{
...
<pre class="brush:csharp; gutter:false; wrap-lines:false; tab-size:2;">public class when_processing_a_payment_with_an_expired_credit_card : PaymentContext
{
	static Exception _exception;
...
<pre class="brush:csharp; gutter:false; wrap-lines:false; tab-size:2;">public static class OrderObjectMother
{
...
<pre class="brush:csharp; gutter:false; wrap-lines:false; tab-size:2;">public class when_placing_a_valid_order : WithSubject&lt;OrderService&gt;
{
	static Order _order;
...
<pre class="brush:csharp; gutter:false; wrap-lines:false; tab-size:2;">public class when_placing_an_invalid_order : WithSubject&lt;OrderService&gt;
{
	static Exception _exception;
...
<pre class="brush:csharp; gutter:false; wrap-lines:false; tab-size:2;">public class OrderBuilder
{
...
<pre class="brush:csharp; gutter:false; wrap-lines:false; tab-size:2;">public class when_placing_an_order_with_an_invalid_credit_card : WithSubject&lt;OrderService&gt;
{
	static Exception _exception;
	static Order _invalidOrder;
